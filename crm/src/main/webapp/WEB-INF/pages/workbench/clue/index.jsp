...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveClue").click(function(){
			...
			var nextContactTime=$("#nextTime").val()
	...
	//封装查询活动函数
	function queryCluesByCondition(pageNo,pageSize){
		//显示市场活动第一页内容，和所有活动的个数
		//获取查询参数
		var owner=$("#query-owner").val()
		var fullname=$.trim($("#query-name").val())
		...
		$.ajax({
			url:"workbench/clue/queryAllClue.do",
			data:{
				fullname:fullname,
				owner:owner,
				company:company,
			...
			success:function(data){
				...
				$.each(data.clues,function(index,obj){
					...
					html+="	<td><a style=\"text-decoration: none; cursor: pointer;\" onclick=\"window.location.href='workbench/clue/toClueDetail.do?id="+obj.id+"';\">"+obj.owner+"</a></td>"
...
<body>
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div style="position: relative;top: 15px;">
							...
							<div class="form-group">
								<label for="nextTime" class="col-sm-2 control-label">下次联系时间</label>
								<div class="col-sm-10" id="next-connect-time" style="width: 300px;">
	...
	<div style="position: relative; top: -20px; left: 0px; width: 100%; height: 100%;">
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div style="height: 50px; position: relative;top: 60px;" id="my_pagination">
