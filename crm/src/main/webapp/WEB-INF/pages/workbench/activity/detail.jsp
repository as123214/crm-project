      ...
      /*      $(".myHref").mouseover(function(){
           ...
           /* $(".myHref").mouseout(function(){
                    ...
                    success:function (data) {
                        if(data.code=='1'){
                          ...
                          var strhtml=''
                            ...
                            strhtml+="<font color=\"gray\">市场活动</font> <font color=\"gray\">-</font> <b>${activity.name}</b> <small style=\"color: gray;\">"+data.retData.createTime+"由${sessionUser.name}创建\"</small>"
            ...
            $("#updateRemarkBtn").click(function () {
                ...
                var id=$("#editRemarkModal input[type='hidden']").val()
                //发送请求
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        if(data.code=='1'){
                            ...
                            $("#div_"+id+" small").val(data.retData.editTime+"由${sessionUser.name}修改")
